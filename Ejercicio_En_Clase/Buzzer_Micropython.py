...
# List of notes for jingle bells
jingle = [
...
# List Twinkle, Twinkle Little Star
twinkle = [
...
class Buzzer:
   ...
   #method play que toma una lista de melodías, el tiempo de espera entre notas, y el valor del ciclo de trabajo (duty),
   #que determina la intensidad del sonido.
...
print("Playing mario")
buzzer.play(mario, 150, 52)
sleep_ms(1000)

print("Playing jingle bells")
buzzer.play(jingle, 180, 25)
sleep_ms(1000)

#tiempo de espera y una intensidad predefinida
